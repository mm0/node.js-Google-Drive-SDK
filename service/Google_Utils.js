...
var Google_Utils =  function(){};
Google_Utils.prototype = {
	
  //public static function urlSafeB64Encode($data) {
	urlSafeB64Encode :	function (data) {
  ...
  //public static function urlSafeB64Encode($data) {
	urlSafeB64Decode	: function(b64) {
		return new Buffer(b64, 'base64').toString('ascii').replace(/-/g,'+').replace(/_/g,'/');
	}
...
*/
module.exports	= new Google_Utils();
